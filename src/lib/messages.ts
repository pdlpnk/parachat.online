...
export type MessageDTO = { system?: {key:string|null; params:{name?:string}}; attachments?: AttachmentDTO[]; sequence: number; authorType: "USER" | "OPERATOR" | "SYSTEM"; text: string; createdAt: string };
